...
/**************************************/
void Calculate_Bessel(double* __restrict Bessel_vector, const int N)
{
	for (int i = 0; i<N; i++) {
...
/***********************************/
void ZeroPadding_CPU(const double2* __restrict data, double2* __restrict U, const double* __restrict Bessel_vector_x, const double* __restrict Bessel_vector_y, const int N1, const int N2)
{
	double a;
	int ind_i, ind_j;
