...
extern "C" {
	...
	__declspec(dllexport)
		void NFFT3_2D_GPU(double * __restrict__ d_x, double * __restrict__ d_y, double * __restrict__ d_s, double * __restrict__ d_t, double *d_f_tmp, double * __restrict__ d_F_stm_tmp, const double eps, const int len_in, const int len_out) {

		double2 *d_f		= (double2 *)d_f_tmp;
		double2 *d_F_stm	= (double2 *)d_F_stm_tmp;
...
#ifdef VERBOSE
		printf("Spatial convolution kernel init\n");
#endif
...
#endif
#ifdef VERBOSE
		printf("Spatial convolution kernel end\n");
#endif
		...
		//timerGPU.StartCounter();
#ifdef VERBOSE
		printf("Spectral convolution start\n");
#endif
...
#endif
#ifdef VERBOSE
		printf("Spectral convolution end\n");
#endif
