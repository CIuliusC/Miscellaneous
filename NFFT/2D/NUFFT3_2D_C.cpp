...
extern "C" {
	...
	__declspec(dllexport)
		...
		void NFFT3_2D_CPU(const double * __restrict x, const double * __restrict y, const double * __restrict s, const double * __restrict t, const fftw_complex * __restrict f, fftw_complex * __restrict F,
